...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.CineOferta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaInicio = new DateTime(2022, 6, 8, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 1,
                            ...
                            FechaFin = new DateTime(2022, 6, 15, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 6, 8, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });

            modelBuilder.Entity("PeliculasWebAPI.Entidades.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.FacturaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.FacturaDetalle", b =>
                {
                    b.HasOne("PeliculasWebAPI.Entidades.Factura", null)
                        .WithMany()
